# Generated by Django 3.0.3 on 2020-04-23 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_price', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.ClassPrice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, help_text='Date time on which the object was last modified.', verbose_name='modified at')),
                ('id', models.CharField(max_length=10, primary_key=True, serialize=False)),
                ('subject_value', models.CharField(blank=True, max_length=150, null=True)),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Teacher')),
            ],
            options={
                'ordering': ['-created', '-modified'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_teacher', models.ForeignKey(help_text='Teacher that receives the rating.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rated_teacher', to='users.Teacher')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': 'created',
