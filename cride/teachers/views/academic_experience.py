...
# Serializers
from cride.users.serializers import AcademicExperienceModelSerializer


# Models


class AcademicExperienceViewSet(mixins.CreateModelMixin,
    ...
    serializer_class = AcademicExperienceModelSerializer
    lookup_field = 'pk'
